...
const PrivacyPolicy = () => {
    return (
        <>
            ...
            <Header active=""/>
            <h1>Privacy Policy for Oishii</h1>

            <p>At Oishii, accessible from http://localhost:3000/, one of our main priorities is the privacy of our
                visitors. This Privacy Policy document contains types of information that is collected and recorded by
                Oishii and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in Oishii. This policy is not applicable to
            ...
            <p>Like any other website, Oishii uses 'cookies'. These cookies are used to store information including
            ...
            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Oishii.</p>

            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on Oishii, which are sent directly to
            ...
            <p>Oishii's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            ...
            <p>Oishii does not knowingly collect any Personal Identifiable Information from children under the age of
