            ...
            <div className="container mt-2">
                ...
                <div className="row">
                    ...
                    <div className="mt-2 col-12 col-lg-9">
                        <div>
                            <h1 className="text-center my-3 wd-terms-title fw-bold text-black">Privacy Policy for Oishii</h1>
                            <p>At Oishii, accessible from http://localhost:3000/, one of our main priorities is the privacy of
                                our visitors. This Privacy Policy document contains types of information that is collected and
                                recorded by Oishii and how we use it.</p>
                            ...
                            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                                website with regards to the information that they shared and/or collect in Oishii. This policy
                            ...
                            <p>Oishii follows a standard procedure of using log files. These files log visitors when they visit
                            ...
                            <p>Like any other website, Oishii uses 'cookies'. These cookies are used to store information
                            ...
                            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                                that are used in their respective advertisements and links that appear on Oishii, which are sent
                            ...
                            <p>Note that Oishii has no access to or control over these cookies that are used by third-party
                                advertisers.</p>
                            <h2 className="wd-terms-title">Third Party Privacy Policies</h2>
                            <p>Oishii's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
                            ...
                            <h2 className="wd-terms-title">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
                            ...
                            <h2 className="wd-terms-title">GDPR Data Protection Rights</h2>
                            ...
                            <p>If you make a request, we have one month to respond to you. If you would like to exercise any of
                                these rights, please contact us.</p>
                            <h2 className="wd-terms-title">Children's Information</h2>
                            <p>Another part of our priority is adding protection for children while using the internet. We
                                encourage parents and guardians to observe, participate in, and/or monitor and guide their
                                online activity.</p>
                            <p>Oishii does not knowingly collect any Personal Identifiable Information from children under the
