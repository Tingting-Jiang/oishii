...
const TermsOfService = () => {
    return (
        <>
            <Helmet>
                <title>Cookie Policy | Oishii</title>
            </Helmet>
            ...
            <div className="container mt-2">
                ...
                <div>
                    <ul className="nav d-flex d-block d-lg-none">
                        ...
                        <li className="nav-item">
                            <a className="nav-link active" href="/cookie-policy">Cookie Policy</a>
                        </li>
                        <li className="nav-item">
                ...
                <div className="row">
                    ...
                    <div className="mt-2 col-12 col-lg-9">
                        <div>
                            <h1 className="text-center my-3 wd-terms-title fw-bold text-black">Cookies Policy</h1>
                            <p>Last updated: December 14, 2021</p>
                            <p>This Cookies Policy explains what Cookies are and how We use them. You should read this
                            ...
                            <p>Cookies do not typically contain any information that personally identifies a user, but
                                ...
                                personal data secure, see our Privacy Policy.</p>
                            <p>We do not store sensitive personal information, such as mailing addresses, account
                                passwords, etc. in the Cookies We use.</p>
                            <h2 className="wd-terms-title">Interpretation and Definitions</h2>
                            <h3 className="wd-terms-title">Interpretation</h3>
                            ...
                            <h3 className="wd-terms-title">Definitions</h3>
                            <p>For the purposes of this Cookies Policy:</p>
                            <ul>
                                <li><strong>Company</strong> (referred to as either &quot;the
                                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies
                                    Policy) refers to Oishii.
                                </li>
                                <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile
                            ...
                            <h2 className="wd-terms-title">The use of the Cookies</h2>
                            <h3 className="wd-terms-title">Type of Cookies We Use</h3>
                            ...
                            <h3 className="wd-terms-title">Your Choices Regarding Cookies</h3>
                            <p>If You prefer to avoid the use of Cookies on the Website, first You must disable the use
                            ...
                            <ul>
                                <li>By email: user-service@oishii.com</li>
                            </ul>
                        </div>
                    </div>
                </div>
